...
<<<<<<< HEAD
  if (fig>0)
  {
     scatterplt= scatter.plot(form,data=dset,
                 clr=clr,rpt=rpt)
  }
...
=======
  ...
  # }
  #
>>>>>>> 7920abf905e81f7162ac0c9c628df9352374adbd
...
<<<<<<< HEAD
  # Add header as requested for report
=======
...
<<<<<<< HEAD
  # Bibliographic Reference on the report

  kw.ref="Altman, N., & Krzywinski, M. (2015). Points of Significance: Association, correlation and causation. Nature methods, 12(10)."
  kw.id="doi:10.1038/nmeth.3587"
  ...
  # return narrative text and method to the report
  ...
  if (rpt)
  {
    ...
    report.method(method=paste0("simple Linear Regression model with ",x.name," as the sole predictor of ",
                  ...
                  purpose=paste0("evaluate the association of ",x.name," and ",y.name,".",
                                 ...
                                 "Therefore, ",
<<<<<<< HEAD
                                 corr.method,"'s correlation ", ref.num, " was used to evaluate the association of ",
=======
                                 corr.method,"'s correlation was used to evaluate the association of ",
>>>>>>> 7920abf905e81f7162ac0c9c628df9352374adbd
                                 x.name," and ",y.name,".  "))
...
<<<<<<< HEAD
  ...
  # archive data in "data" folder if requested

  if (rxv>0)
  {
    dset=data[,c(y.name,x.name)]
